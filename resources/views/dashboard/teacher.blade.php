...
<aside id="sidebar" class="fixed top-0 left-0 h-screen w-64 bg-white border-r flex flex-col z-50 -translate-x-full lg:translate-x-0 transition-transform duration-300">
    ...
    <div class="p-6 border-b flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-xs text-gray-400">Maestro</p>
        </div>
    </div>
    ...
    <nav class="flex-1 p-4 space-y-1 text-sm overflow-y-auto">
        ...
        <a href="{{ route('horarios.index') }}" class="flex items-center gap-2 p-2 rounded-xl hover:bg-gray-100 text-gray-600 transition">
            <span class="material-symbols-outlined text-lg">schedule</span> Horarios
        </a>
        <a href="{{ route('grupos.index') }}" class="flex items-center gap-2 p-2 rounded-xl hover:bg-gray-100 text-gray-600 transition">
            <span class="material-symbols-outlined text-lg">groups</span> Mis Grupos
        </a>
        <a href="{{ route('tareas.index') }}" class="flex items-center gap-2 p-2 rounded-xl hover:bg-gray-100 text-gray-600 transition">
            <span class="material-symbols-outlined text-lg">task</span> Tareas
        </a>
        <a href="{{ route('calificaciones.index') }}" class="flex items-center gap-2 p-2 rounded-xl hover:bg-gray-100 text-gray-600 transition">
...
<div class="lg:ml-64 flex flex-col min-h-screen">
    ...
    <header class="bg-white border-b px-6 py-4 flex justify-between items-center sticky top-0 z-30">
        ...
        <div class="hidden lg:block">
            <h1 class="font-headline font-bold text-lg">Panel del Maestro</h1>
    ...
    <main class="p-6 lg:p-8 space-y-8">
        ...
        <div>
            ...
            <p class="text-gray-400 text-sm mt-1">Bienvenido a tu panel de maestro</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <div class="bg-white p-5 rounded-2xl border shadow-sm hover:-translate-y-1 transition-all">
                ...
                <p class="text-xs text-gray-400 uppercase tracking-widest font-semibold mt-1">Mis Grupos</p>
            </div>
            ...
            <div class="bg-white p-5 rounded-2xl border shadow-sm hover:-translate-y-1 transition-all">
                ...
                <p class="text-xs text-gray-400 uppercase tracking-widest font-semibold mt-1">Tareas creadas</p>
            </div>
        </div>

        <!-- Acciones rápidas + Links -->
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-primary text-white p-6 rounded-2xl shadow-sm flex flex-col justify-between min-h-40">
                <div>
                    ...
                    <h3 class="font-headline text-xl font-bold">Gestiona tus clases</h3>
                </div>
            ...
            <div class="bg-white p-6 rounded-2xl border shadow-sm space-y-2">
                ...
                <a href="{{ route('grupos.index') }}" class="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 transition group">
                    <div class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-primary">groups</span>
                        <span class="text-sm font-medium">Mis grupos</span>
                    </div>
                ...
                <a href="{{ route('horarios.index') }}" class="flex items-center justify-between p-3 rounded-xl hover:bg-gray-50 transition group">
                    <div class="flex items-center gap-3">
